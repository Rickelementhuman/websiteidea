    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <input
          ...
          className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-brand-cyan transition-colors"
          required
        />
      </div>
      <div>
      ...
      <div>
        <select
          ...
          className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/20 text-white focus:outline-none focus:border-brand-cyan transition-colors"
          required
        >
          <option value="" className="bg-[#13202F]">Select your role</option>
          <option value="head-insights" className="bg-[#13202F]">Head of Insights</option>
          <option value="research-director" className="bg-[#13202F]">Research Director</option>
          <option value="head-analytics" className="bg-[#13202F]">Head of Analytics</option>
          <option value="vp-marketing-science" className="bg-[#13202F]">VP Marketing Science</option>
          <option value="strategy-director" className="bg-[#13202F]">Strategy Director</option>
          <option value="other" className="bg-[#13202F]">Other</option>
        </select>
      </div>
      <motion.button
        type="submit"
        className="w-full px-8 py-4 rounded-full font-semibold text-lg"
        style={{
...
export default function AnalystsLeadForm() {
  return (
    ...
    >
      ...
      <div className="relative z-10">
        {/* Hero Section - Lead Form Variant */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-white/50 mb-10 max-w-2xl mx-auto">
                Stop reporting numbers. Start explaining meaning. See how leading brands are using emotion and attention data to finally answer the questions that engagement metrics can't.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 mb-8">
                ...
                <p className="text-sm text-white/40">
                  15-minute demo. See real emotion tracking and attention data in action.
                </p>
              </div>
            </motion.div>
          </div>
        ...
        <section id="demo" className="container mx-auto px-4 py-20 pb-32">
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-white/60 max-w-xl mx-auto">
                      The best way to evaluate our methodology is to see it in action. Book a 15-minute demo and we'll walk through real emotion tracking, attention data, and brand lift results.
                    </p>
                  </div>
                  ...
                  <p className="mt-6 text-sm text-white/40 text-center">
                    See real outputs. Ask methodology questions. No pressure.
                  </p>
                </motion.div>
              </div>
            </NeonGlassBoxV2>
