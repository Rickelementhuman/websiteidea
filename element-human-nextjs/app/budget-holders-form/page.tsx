    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        <input
          ...
          className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/20 text-white placeholder-white/40 focus:outline-none focus:border-brand-yellow transition-colors"
          required
        />
      </div>
      <div>
      ...
      <div>
        <select
          ...
          className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/20 text-white focus:outline-none focus:border-brand-yellow transition-colors"
          required
        >
          <option value="" className="bg-[#13202F]">Select your role</option>
          <option value="head-social" className="bg-[#13202F]">Head of Social/Influencer</option>
          <option value="marketing-director" className="bg-[#13202F]">Marketing Director</option>
          <option value="cmo" className="bg-[#13202F]">CMO</option>
          <option value="brand-manager" className="bg-[#13202F]">Brand Manager</option>
      ...
      <motion.button
        ...
        whileHover={{ scale: 1.02, boxShadow: '0 0 40px rgba(249, 190, 0, 0.6)' }}
        whileTap={{ scale: 0.98 }}
      >
...
export default function BudgetHoldersLeadForm() {
  return (
              ...
              <div className="flex flex-col items-center gap-4">
                <Link href="#demo">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    See How We Prove ROI
                  </motion.button>
                </Link>
                <p className="text-sm text-white/40">
                  15-minute demo. See exactly what you'd present to your CFO.
                </p>
              </div>
            </motion.div>
          </div>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-white/60 max-w-xl mx-auto">
                      The best way to understand what you'd present to your CFO is to see real results. Book a 15-minute demo and we'll show you actual brand lift data, case studies, and deliverables.
                    </p>
                  </div>
                  ...
                  <p className="mt-6 text-sm text-white/40 text-center">
                    See real results. Ask ROI questions. No pressure.
                  </p>
                </motion.div>
              </div>
            </NeonGlassBoxV2>
