    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        >
          ...
          <option value="account-director" className="bg-[#13202F]">Account Director</option>
          <option value="sales-director" className="bg-[#13202F]">Sales Director</option>
          <option value="vp-sales" className="bg-[#13202F]">VP Sales</option>
          <option value="head-partnerships" className="bg-[#13202F]">Head of Partnerships</option>
...
export default function Growth1LeadForm() {
  return (
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-lg text-white/50 mb-10 max-w-2xl mx-auto">
                RFPs now require advanced measurement. Competitors are offering proof you can't match. It's time to level up—or keep losing pitches you should be winning.
              </p>
              ...
              <div className="flex flex-col items-center gap-4 mb-8">
                <Link href="#demo">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                  >
                    See How We Help Agencies Win
                  </motion.button>
                </Link>
                <p className="text-sm text-white/40">
                  15-minute demo. See the exact deliverables that close deals.
                </p>
              </div>
            </motion.div>
          </div>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-lg text-white/60 max-w-xl mx-auto">
                      The best way to understand what we do is to see it. Book a 15-minute demo and we'll show you exactly what your clients would see—including the heat maps and emotion data that close deals.
                    </p>
                  </div>
                  ...
                  <p className="mt-6 text-sm text-white/40 text-center">
                    No pressure. No 47-slide decks. Just the proof that wins pitches.
                  </p>
                </motion.div>
              </div>
            </NeonGlassBoxV2>
